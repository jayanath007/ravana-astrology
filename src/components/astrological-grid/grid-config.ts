...
export const GRID_CONFIG: AreaConfig[] = [
  ...
  // Area 5 - Triangle (bottom-left upper, row 3 col 1)
  {
    id: 5,
    shape: 'triangle',
    points: '0,200 100,200 100,300',
    position: { x: 67, y: 233 }, // Centroid
  },
  ...
  // Area 6 - Triangle (bottom-left lower, row 3 col 1)
  {
    id: 6,
    shape: 'triangle',
    points: '0,200 0,300 100,300',
    position: { x: 33, y: 267 }, // Centroid
  },
  ...
  // Area 8 - Triangle (bottom-right lower, row 3 col 3)
  {
    id: 8,
    shape: 'triangle',
    points: '300,200 200,300 300,300',
    position: { x: 267, y: 267 }, // Centroid
  },
  ...
  // Area 9 - Triangle (bottom-right upper, row 3 col 3)
  {
    id: 9,
    shape: 'triangle',
    points: '200,200 300,200 200,300',
    position: { x: 233, y: 233 }, // Centroid
  },
