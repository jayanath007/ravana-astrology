...
export const GRID_CONFIG: AreaConfig[] = [
  ...
  // Area 3 - Triangle (top-left, lower triangle)
  {
    id: 3,
    shape: 'triangle',
    points: '0,0 0,84 100,83',
    position: { x: 33, y: 55 }, // Centroid
  },
  ...
  // Area 5 - Triangle (bottom-left, upper triangle)
  {
    id: 5,
    shape: 'triangle',
    points: '0,184 100,184 100,283.5',
    position: { x: 67, y: 212 }, // Centroid
  },
  ...
  // Area 6 - Triangle (bottom-left, lower triangle)
  {
    id: 6,
    shape: 'triangle',
    points: '0,184 0,283.5 100,283.5',
    position: { x: 33, y: 254 }, // Centroid
  },
  ...
  // Area 8 - Triangle (bottom-right, lower triangle)
  {
    id: 8,
    shape: 'triangle',
    points: '300,184 200,283.5 300,283.5',
    position: { x: 267, y: 254 }, // Centroid
  },
  ...
  // Area 9 - Triangle (bottom-right, upper triangle)
  {
    id: 9,
    shape: 'triangle',
    points: '200,184 300,184 200,283.5',
    position: { x: 233, y: 212 }, // Centroid
  },
  ...
  // Area 11 - Triangle (top-right, lower triangle)
  {
    id: 11,
    shape: 'triangle',
    points: '300,0 200,83 300,83',
    position: { x: 267, y: 55 }, // Centroid
  },
